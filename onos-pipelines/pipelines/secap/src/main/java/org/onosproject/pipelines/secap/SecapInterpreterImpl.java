...
package org.onosproject.pipelines.secap;
...
import static org.onosproject.pipelines.secap.SecapConstants.EGRESS_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_ETHERNET_DST_ADDR;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_ETHERNET_ETHER_TYPE;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_ETHERNET_SRC_ADDR;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_IPV4_DST_ADDR;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_IPV4_SRC_ADDR;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_IPV4_PROTOCOL;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_UDP_SRC_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_HDR_UDP_DST_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.HDR_STANDARD_METADATA_INGRESS_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_TABLE0_CONTROL_DROP;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_TABLE0_CONTROL_SEND_TO_CPU;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_TABLE0_CONTROL_SET_EGRESS_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_TABLE0_CONTROL_TABLE0;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_WCMP_CONTROL_SET_EGRESS_PORT;
import static org.onosproject.pipelines.secap.SecapConstants.INGRESS_WCMP_CONTROL_WCMP_TABLE;
import static org.onosproject.pipelines.secap.SecapConstants.NO_ACTION;
import static org.onosproject.pipelines.secap.SecapConstants.PORT;

/**
 * Interpreter implementation for secap_switch.p4.
 */
public class SecapInterpreterImpl extends AbstractHandlerBehaviour
    ...
    private static final Map<Integer, PiTableId> TABLE_MAP =
            new ImmutableMap.Builder<Integer, PiTableId>()
                    .put(0, SecapConstants.INGRESS_TABLE0_CONTROL_TABLE0)
                    .build();
    private static final Map<Criterion.Type, PiMatchFieldId> CRITERION_MAP =
            new ImmutableMap.Builder<Criterion.Type, PiMatchFieldId>()
                    ...
                    .put(Criterion.Type.UDP_SRC, HDR_HDR_UDP_SRC_PORT)
                    .put(Criterion.Type.UDP_DST, HDR_HDR_UDP_DST_PORT)
                    .build();
    ...
    public Collection<PiPacketOperation> mapOutboundPacket(OutboundPacket packet)
        ...
        // secap_switch.p4 supports only OUTPUT instructions.
        ...
        for (OutputInstruction outInst : outInstructions) {
            if (outInst.port().isLogical() && !outInst.port().equals(FLOOD)) {
                ...
                // Since secap_switch.p4 does not support flooding, we create a packet
    ...
    public InboundPacket mapInboundPacket(PiPacketOperation packetIn, DeviceId deviceId)
            throws PiInterpreterException {
        // Assuming that the packet is ethernet, which is fine since secap_switch.p4
