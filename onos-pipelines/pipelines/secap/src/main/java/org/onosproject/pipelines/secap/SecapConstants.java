...
/**
 * Constants for secap pipeline.
 */
public final class SecapConstants {

    // hide default constructor
    private SecapConstants() {
    }

    // Header field IDs
    public static final PiMatchFieldId HDR_HDR_UDP_DST_PORT =
            PiMatchFieldId.of("hdr.udp.dst_port");
    ...
    public static final PiMatchFieldId HDR_HDR_UDP_SRC_PORT =
            PiMatchFieldId.of("hdr.udp.src_port");
    ...
    // Table IDs
    public static final PiTableId INGRESS_FIREWALL_CONTROL_FIREWALL =
            PiTableId.of("ingress.firewall_control.firewall");
    ...
    // Action IDs
    public static final PiActionId INGRESS_FIREWALL_CONTROL_SEND_TO_CPU =
            PiActionId.of("ingress.firewall_control.send_to_cpu");
    public static final PiActionId INGRESS_TABLE0_CONTROL_SEND_TO_CPU =
            PiActionId.of("ingress.table0_control.send_to_cpu");
    public static final PiActionId INGRESS_FIREWALL_CONTROL_SET_EGRESS_PORT =
            PiActionId.of("ingress.firewall_control.set_egress_port");
    public static final PiActionId INGRESS_WCMP_CONTROL_SET_EGRESS_PORT =
            PiActionId.of("ingress.wcmp_control.set_egress_port");
    public static final PiActionId INGRESS_FIREWALL_CONTROL_DROP =
            PiActionId.of("ingress.firewall_control.drop");
    ...
    public static final PiActionId INGRESS_FIREWALL_CONTROL_SET_NEXT_HOP_ID =
            PiActionId.of("ingress.firewall_control.set_next_hop_id");
    ...
    public static final PiActionId INGRESS_FIREWALL_CONTROL_NO_ACTION =
            PiActionId.of("ingress.firewall_control.no_action");
    // Action Param IDs
